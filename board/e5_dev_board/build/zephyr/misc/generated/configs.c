...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32_MSI_CLOCK_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32_SPI_SUBGHZ_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32WL_RCC_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32WL_SUBGHZ_RADIO_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_SEMTECH_SX126X, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_LORA_E5_DEV_BOARD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_STM32WLX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32WLE5XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_STM32WL_SUBGHZ_RADIO, 1);
